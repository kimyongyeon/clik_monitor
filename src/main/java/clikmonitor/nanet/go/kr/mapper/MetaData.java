...
import clikmonitor.nanet.go.kr.dto.MetaSearchVO;
import clikmonitor.nanet.go.kr.dto.MetaVO;
...
public interface MetaData {
     ...
     */
    List<MetaVO> selectMetaDataPagingList(MetaSearchVO metaSearchVO);
}
